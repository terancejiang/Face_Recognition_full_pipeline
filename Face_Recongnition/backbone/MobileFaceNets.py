"""
Author: YingJiang
Based on: https://github.com/deepinsight/insightface
"""
...
class MobileFaceNet(Module):
    def __init__(self, fp16=True, num_features=512, blocks=(1, 4, 6, 2), scale=1):
        ...
        self.layers.append( DepthWise(64 * self.scale, 64 * self.scale, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=128))
        self.layers.append( Residual(64 * self.scale, num_block=blocks[1], groups=128, kernel=(3, 3), stride=(1, 1),
                         padding=(1, 1)))
        self.layers.extend(
            [
